...
assert.deepEqual(inferExplicitFeedbackPages('整体文字清晰度需要修正', pages), []);
assert.deepEqual(inferExplicitFeedbackPages('第二页文字乱码', pages), [2]);
assert.deepEqual(mergeAffectedPages([2], [2, 3]), [2, 3]);

console.log('revision feedback: 7/7 passed');
