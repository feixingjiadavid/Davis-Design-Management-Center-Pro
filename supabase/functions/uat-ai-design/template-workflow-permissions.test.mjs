...
assert.equal(roleForTemplateWorkflowAction('answer_content_revision_clarification', 'uat.requester@webank.com'), 'requester');
...
assert.equal(roleForTemplateWorkflowAction('answer_content_revision_clarification', 'davis.design.ai@webank.com'), 'forbidden');
...
console.log('template workflow permissions: 11/11 passed');
